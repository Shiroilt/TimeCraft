...
//                 style={{ whiteSpace: "nowrap", scrollBehavior: "smooth",gap: "30px",padding: "10px 0"}} // Adds padding above and below the row }}
//               >
//                   {categories?.map((c, index) => (
//                     <div
//                       key={c.id}
//                       className="category mx-4 pt-2"
//                       onClick={() => filterCategory(c.title)}
//                       style={{ position: "relative", overflow: "hidden" , display: "inline-block", minWidth: "120px",textAlign: "center" }} // Ensure the parent div has relative positioning and hidden overflow
//                     >
//                       <img
//                         src={c.image}
//                         style={{
...
//                         alt=""
//                       />
//                       <h6 style={{ zIndex: 1, marginTop: "8px" }}>{c.title}</h6>
//                     </div>
//                   ))}
//                 </div>
//               )}
...
//                   {/* <h2 className="fw-light">Find the Perfect Invitation for Your <br></br>Special Event</h2>   chnage by yashi  */}
//                   <p className="lead text-muted">
//                     {/*i change in to this text  */}
//                     <h3>Check Out Wide Range of Cards</h3>
//                   </p>
//                 </div>
//               </div>
//               {isLoadingProducts && (
...
//                 <div className="col-lg-6 col-md-8 mx-auto">
//                 <h1 className="fw-light">Trending Invitations from Top Designers</h1>
//                   <p className="lead text-muted">
//                     {/* Explore the latest and most popular invitation designs from talented vendors across our platform. */}
//                   </p>
//                 </div>
//               </div>
        ...
        <main className="bg-light">
          <div className="container mt-4">
            <section className="text-center">
              ...
              {!isLoadingCategories && (
                <div className="d-flex overflow-auto no-scrollbar" style={{ gap: "30px", padding: "10px 0" }}>
                  {categories?.map((c) => (
                    <div
                      key={c.id}
                      className="category mx-4 pt-2"
                      onClick={() => filterCategory(c.title)}
                      style={{ position: "relative", display: "inline-block", minWidth: "120px", textAlign: "center" }}
                    >
                      <img
                        src={c.image}
                        style={{
                  ...
                  {products?.map((p) => (
                    <div key={p.id} className="col-xl-4 col-md-6 col-12 mb-4">
                      <div className="card h-100 shadow-sm" style={{ borderRadius: "1rem" }}>
                        ...
                        <div className="card-body">
                          <Link to={`/detail/${p.slug}`} className="text-reset text-decoration-none">
                            <h5 className="card-title mb-3">{p.title}</h5>
                          </Link>
                          <Link to={`/detail/${p.slug}`} className="text-info text-decoration-none">
                            <p>{p.category?.title}</p>
                          </Link>
                          <div className="d-flex justify-content-center">
                            <h6 className="mb-3">₹{p.price}</h6>
