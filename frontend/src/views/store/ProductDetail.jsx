...
function ProductDetail() {
  ...
  return (
    <main className="mb-4 mt-4" style={{ backgroundColor: '#f8f9fa', padding: '20px' }}>
      <div className="container">
        <section className="mb-9">
          <div className="row gx-lg-5">
            <div className="col-md-6 mb-4 mb-md-0">
...
/>
            ...
            <div className="col-md-6 mb-4 mb-md-0">
              <h1 className="fw-bold mb-3" style={{ color: '#6c757d' }}>{product.title}</h1>
                  ...
                  <li>
                    {[...Array(5)].map((_, index) => (
                      <i
                        key={index}
                        className={`fa fa-star fa-sm ${index < product?.product_rating ? "text-warning" : "text-dark"} ps-0`}
                        title={index < product?.product_rating ? "Rated" : "Not Rated"}
                      />
                    ))}
                  </li>
                  <li style={{ marginLeft: 10, fontSize: 13 }}>
                    <span href="" className="text-decoration-none">
                      <strong className="me-2">
                        {product?.rating_count > 0 ? `${product?.product_rating}/5` : "0/5"}
                      </strong>
                      ({product?.rating_count} reviews)
                    </span>
                  </li>
                          ...
                          <div className="ps-4">
                            ...
                            {[...Array(5)].map((_, index) => (
                              <i
                                key={index}
                                className={`fa fa-star fa-sm ${index < r?.rating ? "text-warning" : "text-dark"} ps-0`}
                                title={index < product?.rating ? "Rated" : "Not Rated"}
                              />
                            ))}
                          </div>
                        </div>
