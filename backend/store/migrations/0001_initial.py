    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('product_status', models.CharField(choices=[('approved', 'Approved'), ('disapproved', 'Disapproved'), ('modify', 'Modify'), ('printing', 'Printing'), ('out_of_delivery', 'Out of Delivery')], default='approved', max_length=20)),
